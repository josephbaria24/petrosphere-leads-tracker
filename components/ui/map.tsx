...
// PlaceAutocomplete import removed (MapSearchControl disabled)
type PlaceAutocompleteProps = Record<string, unknown>
...
function MapSearchControl(_props: PlaceAutocompleteProps & { position?: string }): null {
    if (typeof window !== "undefined") console.warn("MapSearchControl is disabled in this build");
    return null;
}
