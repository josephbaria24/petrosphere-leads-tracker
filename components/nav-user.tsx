        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <SidebarMenuButton
              ...
              tooltip={user.name}
              className={cn(
                "h-auto rounded-lg px-2 py-1.5 hover:bg-zinc-200/60",
            ...
            >
              <div className="relative shrink-0">
                <Avatar className="size-8 rounded-full group-data-[collapsible=icon]:size-9">
                  {showAvatar && (
              ...
              <ChevronsUpDown className="ml-auto size-3.5 shrink-0 text-zinc-500 group-data-[collapsible=icon]:hidden" />
            </SidebarMenuButton>
          </DropdownMenuTrigger>
          <DropdownMenuContent
